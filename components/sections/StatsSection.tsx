    ...
    >
      ...
      >
        ...
        <div style={{ transform: "translateZ(20px)", transformStyle: "preserve-3d" }}>
          ...
          <p className="text-xs text-[#F5E6D0] tracking-[0.2em] uppercase mt-4 font-semibold">
            {stat.label}
          </p>
        </div>
      ...
      <div className="sm:hidden grid grid-cols-2 gap-3">
        {stats.map((stat, si) => (
          ...
          >
            ...
            <p className="text-[10px] text-[#F5E6D0] tracking-[0.18em] uppercase leading-snug font-semibold">{stat.label}</p>
          </motion.div>
        ))}
      </div>
    </div>
